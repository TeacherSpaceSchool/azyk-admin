...
import { downloadEmployments } from '../../../src/gql/uploadDownload'
                ...
                <CardContent className={classes.column} style={isMobileApp?{}:{justifyContent: 'start', alignItems: 'flex-start'}}>
                    ...
                    <Button variant='contained' size='small' color='primary' onClick={async () => {
                        if(organization&&organization._id) {
                            showLoad(true)
                            window.open(await downloadEmployments({
...
DownloadEmployments.getInitialProps = async function(ctx) {
...
export default connect(mapStateToProps, mapDispatchToProps)(DownloadEmployments);