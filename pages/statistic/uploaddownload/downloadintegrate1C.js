...
import { downloadIntegrate1C } from '../../../src/gql/integrate1C'
                ...
                <CardContent className={classes.column} style={isMobileApp?{}:{justifyContent: 'start', alignItems: 'flex-start'}}>
                    ...
                    <Button variant='contained' size='small' color='primary' onClick={() => {
                        if(organization&&document) {
                            const action = async () => {
                                let res = await downloadIntegrate1C({
...
DownloadIntegrate1C.getInitialProps = async function(ctx) {
...
export default connect(mapStateToProps, mapDispatchToProps)(DownloadIntegrate1C);