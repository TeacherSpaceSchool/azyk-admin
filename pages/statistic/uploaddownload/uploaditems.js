            ...
            <Card className={classes.page}>
                <CardContent className={classes.column} style={isMobileApp?{}:{justifyContent: 'start', alignItems: 'flex-start'}}>
                    <div className={classes.row}>
                        Формат xlsx: GUID товара из 1С, название товара, конечная цена товара, количество товара в упаковке, вес товара в килограммах, приоритет, продается ли товар поштучно(1 - да).
                    </div>
                    <div className={classes.row}>
                        <Autocomplete
