...
import { getStatisticReturned } from '../../../src/gql/statistic'
...
const ReturnedStatistic = React.memo((props) => {
    ...
    let [statisticReturned, setStatisticReturned] = useState(null);
    ...
    return (
        <App cityShow pageName='Возвраты'>
            <Head>
            ...
            <Card className={classes.page}>
                <CardContent className={classes.column} style={isMobileApp?{}:{justifyContent: 'start', alignItems: 'flex-start'}}>
                    ...
                    {
                        statisticReturned?
                            <StatisticTable type='item' row={(statisticReturned.row).slice(1)} columns={statisticReturned.columns}/>
                            :null
                    }
                </CardContent>
            </Card>
