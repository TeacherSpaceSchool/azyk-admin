...
const Statistic = React.memo((props) => {
    ...
    const list = {
        ...
        tools: [
            ...
            {
                name: 'Клиенты без акции',
                link: profile.organization?`/tools/clientswithoutads/${profile.organization}`:'/organizations?path=statistic/tools/clientswithoutads&title=Клиенты без акции',
