...
const ReturnedConfirmedV2 =  React.memo(
    (props) =>{
...
ReturnedConfirmedV2.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(dialogContentStyle)(ReturnedConfirmedV2));