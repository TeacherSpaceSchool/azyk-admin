...
import cardRouteStyle from '../../src/styleMUI/district/cardDistrict'
...
const CardDistrict = React.memo((props) => {
    ...
    return (
        <Card className={isMobileApp?classes.cardM:classes.cardD}>
            <Link href='/district/[id]' as={`/district/${element?element._id:'new'}`}>
                <CardActionArea>
                    <CardContent className={classes.column}>
                        ...
                        </div>
                        {
                            element.manager?
                                <div className={classes.row}>
                                    <div className={classes.nameField}>Супервайзер:&nbsp;</div>
